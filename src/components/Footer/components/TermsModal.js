      ...
      <ModalContent>
        ...
        <ModalBody maxH={"70vh"} overflowY={"scroll"}>
          ...
          <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
            ...
            https://selfjourney-et.com website as well as any other media form,
            ...
            registered in Ethiopia and have our registered office at Gabon
            Street, Jeme'a Building 7th Floor 702, Addis Ababa, Addis Ababa. You
            ...
            the extent local laws are applicable. The Site is intended for users
          ...
          <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
            You may be required to register before using the Site. You must Send
            OK to 9876 or confirm your subscription via the website after
            ...
            available to you in exchange for a daily charge. You will be billed
            on the daily anniversary date of the subscription or of the last
            successful billing attempt. We assume no liability for Service
            subscription error for the wrong telephone, device or platform. We
            will not be liable for any errors on billing statements issued to
            you by your carrier. You reserve the right to remove, reclaim, or
            change your account information within our service. You can either
            email us on hello@selfjourney-et.com or call +251 911 520105 for any
          ...
          <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
            ...
            Ethiopia. If you access the Site from any other region of the world
            with laws or other requirements governing personal data collection,
            use, or disclosure that differ from applicable laws in Ethiopia,
            then through your continued use of the Site, you are transferring
            your data to Ethiopia, and you agree to have your data transferred
            to and processed in Ethiopia.
          </h1>
          ...
          <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
            ...
            the Ethiopia courts. Jaktech Engineering and Trading shall also
          ...
          <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
            ...
            <br /> contact us at: Jaktech Engineering and Trading Gabon Street,
            Jeme'a Building
            <br />
