...
const LoginModal = ({ isModalOpen, handleModal, setIsModalOpen, phoneNo }) => {
                  ...
                  <div className=" grid grid-cols-1 sm:grid-cols-2">
                    <div className="bg-[#EAF5FC] hidden sm:flex sm:flex-col items-start space-y-2 flex-grow w-full">
                      <div className="p-3">
                        ...
                        <h1 className="font-semibold text-black text-3xl pt-3">
                          Discover Lifelong{" "}
                          <span className="text-[#00a69c]">Journey</span>
                        </h1>
                        <img
                          src={Login}
                          alt=""
                        ...
                        {!hasPhone ? (
                          <div className="flex flex-col items-start flex-grow w-full space-y-1  ">
                            ...
                            <div className="flex items-center     border-2 rounded-md border-[#00a69c] w-full">
                              <span className="border-r-2 border-[#00a69c]  rounded-l-md h-full flex flex-grow text-center px-2 items-center justify-center ">
                                +251
                              </span>
                              <input
                                type="number"
                            ...
                            <div className="flex items-center space-x-2 pt-3">
                              ...
                              <p
                                ...
                                className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px]"
                              >
                                {" "}
                                {isAmh
  ...
  hover:opacity-70 '>Log in</button> */}
                        ...
                        <button
                          ...
                          disabled={
                            otpMutation.isLoading || loginMutation.isLoading
                          }
  ...
  hover:opacity-70 "
    ...
    hover:underline"
      ...
      <AgreeModal
        ...
        setIsAgreeModalOpen={setIsAgreeModalOpen}
        isAgreed={isAgreed}
      />
    </div>
  );
