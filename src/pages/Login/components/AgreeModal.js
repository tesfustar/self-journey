        ...
        <ModalContent>
          ...
          <ModalBody maxH={"70vh"} overflowY={"scroll"}>
            ...
            <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
              ...
              We are registered in Ethiopia and have our registered office at
              Gabon Street, Jeme'a Building 7th Floor 702, Addis Ababa, Addis
              Ababa. You agree that by accessing the Site, you have read,
              ...
              USE IMMEDIATELY. Supplemental terms and conditions or documents
              ...
              to the extent local laws are applicable. The Site is intended for
              users who are at least 13 years of age. All users who are minors
              in the jurisdiction in which they reside (generally under the age
              of 18) must have the permission of, and be directly supervised by,
              their parent or guardian to use the Site. If you are a minor, you
            ...
            <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
              You may be required to register before using the Site. You must
              Send OK to 9876 or confirm your subscription via the website after
              reading the terms and conditions to take advantage of our Self
              Journey service. This Service is a daily subscription service
              available to you in exchange for a daily charge. You will be
              billed on the daily anniversary date of the subscription or of the
              last successful billing attempt. We assume no liability for
              Service subscription error for the wrong telephone, device or
              platform. We will not be liable for any errors on billing
              statements issued to you by your carrier. You reserve the right to
              remove, reclaim, or change your account information within our
              service. You can either email us on hello@selfjourney-et.com or
              call +251 911 520105 for any issues related to your account.
            </h1>
            ...
            <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
              Once you subscribe to our website or service, you will receive a 3
              days free trial to gain access to our platform and enjoy the daily
              updated content, after which time we charge 2 birr per day, your
              daily subscription to the Service will be automatically renewed
              until you send an unsubscription request. You can send an
              unsubscribe request by clicking the "unsubscribe" link on the home
              page or sending “STOP” to 9876. Your payment will be processed
              automatically through mobile phone number balance and is the only
              payment method in Service.
            </h1>
            <h1 className="text-gray-700 font-bold cursor-pointer hover:underline text-[15px] ">
            ...
            <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
              ...
              Ethiopia. If you access the Site from any other region of the
              ...
              Ethiopia, then through your continued use of the Site, you are
              transferring your data to Ethiopia, and you agree to have your
              data transferred to and processed in Ethiopia.
            </h1>
            ...
            <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
              ...
              Ethiopia. Jaktech Engineering and Trading and yourself irrevocably
              consent that the courts of Ethiopia shall have exclusive
              jurisdiction to resolve any dispute which may arise in connection
              with these terms. Our failure to enforce any right or provision of
            ...
            <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
              ...
              of the Ethiopia courts. Jaktech Engineering and Trading shall also
            ...
            <h1 className="text-gray-500 font-medium cursor-pointer hover:underline text-[13px] py-2">
              ...
              provide at least 60 days notice prior to any new terms taking
