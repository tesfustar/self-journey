...
const RegisterPage = () => {
  ...
  const registerMutation = useMutation(
    async (newData) =>
      await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}link-subscribe`,
        newData,
        {
          headers,
        }
      ...
      <div className=" w-full">
        <div className="w-full py-20 md:py-28 flex flex-col space-y-3  items-center justify-center ">
              ...
              <div className="w-full flex flex-col items-center space-y-2">
                ...
                <div className="">
                  <p className="text-sm font-light">
                    {isAmh ? "ለመቀጠል:" : "To continue: "}
                  </p>
                  <p className="text-sm font-light">
                    {isAmh ? "1. የእርስዎን Wi-Fi ያጥፉ:" : "1. Turn off your Wi-Fi "}
                  </p>
                  <p className="text-sm font-light">
                    {isAmh
                      ? "2. የስልክዎን ሞባይል ዳታ ያብሩ"
                      : "2. Activate your mobile data "}
                  </p>
                  <p className="text-sm font-light">
                    {isAmh
                      ? "3. ሰብስክራይብ ለማድረግ ከስር ይጫኑ"
                      : "3. Press below to Subscribe "}
                  </p>
                </div>
              </div>
          ...
          transition-all ease-in-out duration-300 rounded-md"
            ...
            <p className="flex items-center justify-center w-full text-center pt-3 text-sm">
              {isAmh
                ? `ወይም ለአገልግሎቱ ለመመዝገብ OK ብለው ወደ 9876 ይላኩ! ዋጋ፡ በቀን 2 ብር`
                : "...or send OK to 9876 to join!Cost: 2 birr/day"}
            </p>
          </div>
          {isLargerThan768 ? (
            isAmh ? (
